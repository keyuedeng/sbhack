...
const analyzeSession_1 = require("./analyzeSession");
const caseLoader_1 = require("../services/caseLoader");
/**
 * Create a mock session with example data
 */
function createMockSession(caseData, level, scenario) {
    const now = Date.now();
...
async function runTests() {
    ...
    try {
        ...
        const caseData = (0, caseLoader_1.loadCase)('chest-pain-001');
        console.log(`\n📋 Case: ${caseData.title}`);
        ...
        for (const scenario of scenarios) {
            ...
            const feedback = (0, analyzeSession_1.analyzeSession)(session, caseData);
            // Display results
            console.log(`\n📊 SCORING BREAKDOWN:`);
